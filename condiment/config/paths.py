...
import os
from condiment.config.base import BASEDIR

reprepro_dir = os.path.join(BASEDIR, 'test_repo')
sample_packages_dir = os.path.join(BASEDIR, 'package_samples')
selected_packages =  os.path.join(BASEDIR, 'condiment', 'config', 'data',
                                  'selected_packages.list')
distributions_path = os.path.join(BASEDIR, 'condiment', 'config', 'data',
                                  'dists-template')
