...
from condiment.common.fabric.docker import (docker_generate_debian_base_image,
                                         docker_generate_condiment_base_image,
                                         docker_kill_all_containers,
                                         docker_kill_all_images,
                                         docker_kill_condiment_images,
...
from condiment.common.fabric.vagrant import (vagrant_generate_debian_base_image,
                                          vagrant_generate_condiment_base_image,
                                          vagrant_kill_all_containers,
                                          vagrant_kill_all_images,
                                          vagrant_kill_condiment_images,
                                          vagrant_pull_debian_base_image,
                                          vagrant_pull_condiment_base_image,
                                          vagrant_check_container,
                                          vagrant_stop_container,
                                          vagrant_login_container,
                                          vagrant_reset_container,
                                          vagrant_update_container)
from condiment.common.fabric.environ import (docker_enable_environment,
...
FABRIC_FUNCTION_MAP = {
    'docker': {
        ...
        'generate_condiment_base_image': docker_generate_condiment_base_image,
        'pull_debian_base_image': docker_pull_debian_base_image,
        'pull_condiment_base_image': docker_pull_condiment_base_image,
        'kill_all_containers': docker_kill_all_containers,
        'kill_condiment_images': docker_kill_condiment_images,
    ...
    'vagrant': {
        ...
        'generate_condiment_base_image': vagrant_generate_condiment_base_image,
        'pull_debian_base_image': vagrant_pull_debian_base_image,
        'pull_condiment_base_image': vagrant_pull_condiment_base_image,
        'kill_all_containers': vagrant_kill_all_containers,
        'kill_condiment_images': vagrant_kill_condiment_images,
