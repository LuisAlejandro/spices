...
from condiment.web.cloud.models import Package, Details
from condiment.common.utils import md5Checksum, list_items, readconfig

logger = get_logger()
# hdlr = logging.FileHandler(os.path.join(BASEDIR, 'condiment_recorder.log'))
